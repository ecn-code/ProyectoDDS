...
public class FabricaEntidadesDinamicas implements InterfazFabrica {
	...
	public Entidad crearEntidad(String name,float [] parametros, TextureRegion textura ) {
		...
		}else if(name.equals("EnemigoSeno")){
			return new EnemigoSeno(parametros[0], parametros[1], parametros[2], parametros[3], parametros[4], parametros[5], textura);
		}
			return null;			
	}
