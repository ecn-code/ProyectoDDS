...
public static Animation mocoRojoDerecha = new Animation(0.2f, new TextureRegion[] {mocoRojo1, mocoRojo2});
public static Animation mocoRojoIzquiera = mocoRojoDerecha;
